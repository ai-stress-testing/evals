...
**Capabilities**
- Implements React components/hooks/client state per spec + ticket
- Wires client to backend APIs per the agreed contract
...
- [ ] Matches the design spec's states (default/loading/empty/error)
- [ ] Reuses existing components/utilities where one already covers the
      need, instead of duplicating
